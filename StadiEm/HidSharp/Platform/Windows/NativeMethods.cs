...
namespace HidSharp.Platform.Windows
{
    internal unsafe static class NativeMethods
    {
        ...
        static internal extern bool SetupDiSetClassInstallParams( HDEVINFO deviceInfoSet, ref SP_DEVINFO_DATA deviceInfoData, ref SP_PROPCHANGE_PARAMS classInstallParams, int classInstallParamsSize );

        [DllImport( "setupapi.dll", CharSet = CharSet.Auto )]
        static internal extern bool SetupDiCallClassInstaller( int installFunction, HDEVINFO deviceInfoSet, ref SP_DEVINFO_DATA deviceInfoData );
    }
}
